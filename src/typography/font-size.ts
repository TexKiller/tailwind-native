...
export const text_size = (size: TemplateStringsArray) => css`
  font-size: ${size[0]};
`;
const textVariant = (variant: TemplateStringsArray) => css`
  font-size: var(--text-${variant[0]});
  line-height: var(--text-${variant[0]}-line-height);
`;
