...
const parseTranslate = (value: string) =>
  /^-?(0|[1-9]\d*)(\.\d*)?/.test(value)
    ...
    : (/^-?(0|[1-9]\d*)(\.\d*)\/-?(0|[1-9]\d*)(\.\d*)?/.test(value) &&
        `calc(${value} * 100%)`) ||
      value;
export const translate = (value: string) => css`
  translate: ${parseTranslate(value)} ${parseTranslate(value)};
`;
...
export const translate_x = (value: string) => css`
  translate: ${parseTranslate(value)} var(--tw-translate-y);
`;
...
export const translate_y = (value: string) => css`
  translate: var(--tw-translate-x) ${parseTranslate(value)};
`;
...
export const translate_z = (value: string) => css`
  translate: var(--tw-translate-x) var(--tw-translate-y)
    ${parseTranslate(value)};
`;
