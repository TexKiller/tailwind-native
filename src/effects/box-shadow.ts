...
export const shadow = (value: string) => css`
  box-shadow: ${value};
`;
...
export const shadow_color = (value: string) => css`
...
export const ring = (value: string = "1px") => css`
...
export const inset_ring = (value: string = "1px") => css`
